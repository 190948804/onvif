...
func Call_GetRecordingJobs(ctx context.Context, dev *onvif.Device, request record.GetRecordingJobs) (record.GetRecordingJobsResponse, error) {
	type Envelope struct {
		Header struct{}
		Body   struct {
			GetRecordingJobsResponse record.GetRecordingJobsResponse
		}
	}
	var reply Envelope
